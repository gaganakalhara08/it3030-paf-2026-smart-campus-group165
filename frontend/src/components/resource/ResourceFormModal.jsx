...
const Input = ({ error, ...props }) => (
  <input
    {...props}
    className={`w-full h-10 px-3 rounded-xl border text-sm focus:outline-none focus:ring-2 focus:ring-purple-400 focus:border-transparent ${
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          <Field label="Description">
            <textarea
              ...
              rows={3}
              className="w-full px-3 py-2 rounded-xl border border-slate-200 text-sm focus:outline-none focus:ring-2 focus:ring-purple-400 focus:border-transparent resize-none"
            />
          </Field>
          ...
          <div className="flex gap-3 pt-2">
            ...
            <button type="submit" disabled={loading}
              className="flex-1 h-11 rounded-xl bg-purple-600 text-white text-sm font-semibold hover:bg-purple-700 disabled:opacity-60 transition-colors">
